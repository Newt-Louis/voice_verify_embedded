...
def main():
    ...
    output_dir = os.path.join(project_root, "quantization/ggml-whispersmall-multilingual/q5_1")
    output_model = os.path.join(output_dir, "ggml-model-q5_1.bin")
    
    os.makedirs(output_dir, exist_ok=True)
    
    print(f"--- BẮT ĐẦU LƯỢNG TỬ HÓA Q5_1 ---")
    cmd = [quantize_tool, source_model, output_model, "q5_1"]
