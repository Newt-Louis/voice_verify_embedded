...
def main():
    ...
    # Đổi sang thư mục Q5_0
    output_dir = os.path.join(project_root, "quantization/ggml-whispersmall-multilingual/q5_0")
    output_model = os.path.join(output_dir, "ggml-model-q5_0.bin")
    ...
    print(f"--- BẮT ĐẦU LƯỢNG TỬ HÓA Q5_0 ---")
    ...
    cmd = [quantize_tool, source_model, output_model, "q5_0"]
