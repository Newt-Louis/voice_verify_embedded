...
def run_test():
    print("\n" + "="*60)
    print(" [MỐC 1 - PROPER] TEST ĐỐI SOÁT: FP32 VS FP16 (ONNX ONLY)")
    print("="*60)
    ...
    print("\n" + "="*60)
    print(f" KẾT QUẢ MỐC 1 PROPER (FLOAT16)")
    print("="*60)
    print(f"- Dung lượng:   {final_data['storage_mb']:.2f} MB")
    ...
    history["v1_fp16_proper"] = final_data
